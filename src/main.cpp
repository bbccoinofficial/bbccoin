...
const string strMessageMagic = "bbccoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "bbccoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "bbbcoin is the next big thing"; //"bbccoin is here!";
        CTransaction txNew;
        txNew.nTime = 1506116470;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1507528027;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 208699;
		if(fTestNet)
        {
            block.nTime    = 1507497792;
            block.nNonce   = 0;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xd5dde090a559728f97558896ec0fdfc453e749c128dc7339020c2d16461eb402"));
        block.print();
